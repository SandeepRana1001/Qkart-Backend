...
describe("Cart routes", () => {
  describe("Checkout", () => {
    it("should return 401 if access token is missing", async () => {
      ...
      // Done: CRIO_TASK_MODULE_TEST - Assert if status code is "401 UNAUTHORIZED"
    ...
    it("should return 400 if cart is empty", async () => {
      ...
      // Done: CRIO_TASK_MODULE_TEST - Assert if status code is "400 BAD REQUEST"
    ...
    it("should return 400 if not enough wallet balance", async () => {
      ...
      // Done: CRIO_TASK_MODULE_TEST - Assert if status code is 400
      expect(res.status).toEqual(httpStatus.BAD_REQUEST)
    });
